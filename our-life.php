...
<body
  ...
  <section
    ...
    style="
        background-image: url(&quot;img/about/about_head_banner.jpg&quot;);
      ">
              ...
              <div class="atropos-scale">
                <div class="atropos-rotate">
                  <div class="atropos-inner" data-atropos-offset="3">
                    <div class="gallery-box">
                      <a
                        href="img/lifeat/image02.png"
                        data-group="lightbox-group-gallery-item-2"
                        title="Lightbox gallery image title">
                        <div
                          class="position-relative gallery-image bg-slate-blue">
                          <img src="img/lifeat/image02.png" alt="" />
                          <div
                            class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                            <i
                              class="bi bi-camera icon-medium text-white"></i>
              ...
              <div class="atropos-scale">
                <div class="atropos-rotate">
                  <div class="atropos-inner" data-atropos-offset="3">
                    <div class="gallery-box">
                      <a
                        href="img/lifeat/image03.png"
                        data-group="lightbox-group-gallery-item-2"
                        title="Lightbox gallery image title">
                        <div
                          class="position-relative gallery-image bg-slate-blue">
                          <img src="img/lifeat/image03.png" alt="" />
                          <div
                            class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                            <i
                              class="bi bi-camera icon-medium text-white"></i>
              ...
              <div class="atropos-scale">
                <div class="atropos-rotate">
                  <div class="atropos-inner" data-atropos-offset="3">
                    <div class="gallery-box">
                      <a
                        href="img/lifeat/image04.png"
                        data-group="lightbox-group-gallery-item-2"
                        title="Lightbox gallery image title">
                        <div
                          class="position-relative gallery-image bg-slate-blue">
                          <img src="img/lifeat/image04.png" alt="" />
                          <div
                            class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                            <i
                              class="bi bi-camera icon-medium text-white"></i>
              ...
              <div class="atropos-scale">
                <div class="atropos-rotate">
                  <div class="atropos-inner" data-atropos-offset="3">
                    <div class="gallery-box">
                      <a
                        href="img/lifeat/image05.png"
                        data-group="lightbox-group-gallery-item-2"
                        title="Lightbox gallery image title">
                        <div
                          class="position-relative gallery-image bg-slate-blue">
                          <img src="img/lifeat/image05.png" alt="" />
                          <div
                            class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                            <i
                              class="bi bi-camera icon-medium text-white"></i>
              ...
              <div class="atropos-scale">
                <div class="atropos-rotate">
                  <div class="atropos-inner" data-atropos-offset="3">
                    <div class="gallery-box">
                      <a
                        href="img/lifeat/image06.png"
                        data-group="lightbox-group-gallery-item-2"
                        title="Lightbox gallery image title">
                        <div
                          class="position-relative gallery-image bg-slate-blue">
                          <img src="img/lifeat/image06.png" alt="" />
                          <div
                            class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                            <i
                              class="bi bi-camera icon-medium text-white"></i>
  ...
  <section class="bg-solitude-blue">
    <div class="container">
      <div
        class="row justify-content-center align-items-center mb-5 text-center text-lg-start">
        <div class="col-xxl-7 col-lg-7 md-mb-20px">
          <h3 class="text-dark-gray fw-600 ls-minus-2px mb-0">
            <span class="w-20px h-4px d-inline-block bg-base-color me-10px">
            </span>
            FESTIVE CELEBRATIONS
          </h3>
        </div>
        <div
          class="col-xxl-5 col-lg-5 col-md-8 col-sm-10 last-paragraph-no-margin">
          <p>
            Immerse yourself in the joy of festivals with us! From vibrant
            decorations to special offers, our festive celebrations bring a
            touch of magic at PropAdvisor.
          </p>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <ul
            class="image-gallery-style-03 gallery-wrapper grid grid-3col xxl-grid-3col xl-grid-3col lg-grid-3col md-grid-1col sm-grid-1col xs-grid-1col gutter-extra-large">
            <li class="grid-sizer"></li>
            <!-- start gallery item -->
            <li class="grid-item transition-inner-all">
              <div class="gallery-box overflow-hidden">
                <a
                  href="img/lifeat/festive_01.png"
                  data-group="lightbox-group-gallery-item-3"
                  title="Lightbox gallery image title">
                  <div class="position-relative gallery-image bg-base-color">
                    <img src="img/lifeat/festive_01.png" alt="" />
                    <div
                      class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                      <i
                        class="feather icon-feather-search icon-very-medium text-white"></i>
                    </div>
                  </div>
                </a>
              </div>
            ...
            <li class="grid-item transition-inner-all">
              <div class="gallery-box overflow-hidden">
                <a
                  href="img/lifeat/festive_02.png"
                  data-group="lightbox-group-gallery-item-3"
                  title="Lightbox gallery image title">
                  <div class="position-relative gallery-image bg-base-color">
                    <img src="img/lifeat/festive_02.png" alt="" />
                    <div
                      class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                      <i
                        class="feather icon-feather-search icon-very-medium text-white"></i>
            ...
            <li class="grid-item transition-inner-all">
              <div class="gallery-box overflow-hidden">
                <a
                  href="img/lifeat/festive_03.png"
                  data-group="lightbox-group-gallery-item-3"
                  title="Lightbox gallery image title">
                  <div class="position-relative gallery-image bg-base-color">
                    <img src="img/lifeat/festive_03.png" alt="" />
                    <div
                      class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                      <i
                        class="feather icon-feather-search icon-very-medium text-white"></i>
            ...
            <li class="grid-item transition-inner-all">
              <div class="gallery-box overflow-hidden">
                <a
                  href="img/lifeat/festive_04.png"
                  data-group="lightbox-group-gallery-item-3"
                  title="Lightbox gallery image title">
                  <div class="position-relative gallery-image bg-base-color">
                    <img src="img/lifeat/festive_04.png" alt="" />
                    <div
                      class="d-flex align-items-center justify-content-center position-absolute top-0px left-0px w-100 h-100 gallery-hover move-bottom-top">
                      <i
                        class="feather icon-feather-search icon-very-medium text-white"></i>
