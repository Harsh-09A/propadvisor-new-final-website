            ...
            <a href="contact.html">
              <div class="feature-box feature-box-left-icon-middle">
                <div
                  ...
                  <i
                    class="feather icon-feather-arrow-right text-dark-gray icon-extra-medium"></i>
                </div>
                <div class="feature-box-content">
                  <a
                    href="contact.html"
                    class="d-inline-block fs-19 text-white text-shadow-double-large">Schedule A Consultation</a>
                </div>
              </div>
            </a>
          </div>
  ...
  <template>
    ...
    <section id="down-section">
      <div class="container">
        <div class="row align-items-center justify-content-center">
                ...
                <div class="atropos-rotate">
                  <div class="atropos-inner">
                    <div data-atropos-offset="3">
                      <img
                        src="img/buyers/buyers_800x925.jpg"
          ...
          <div
            class="col-xl-5 col-lg-6 offset-lg-1 col-md-9 ps-1 text-center text-lg-start lg-ps-15px"
            ...
            <h3
              ...
              Making Home Buying Transparent, Simple, and Stress-Free
            </h3>
            <p>
              Whether you’re a first-time buyer, NRI, or investor, we make
              every step transparent and smooth.
            </p>
    ...
    <section>
      <div class="container">
        ...
        <div
          class="row row-cols-1 row-cols-lg-5 row-cols-sm-2 mb-5 ms-2 me-2 sm-mb-40px">
          ...
          <div
            ...
            <div class="process-step-icon-box position-relative mb-25px">
              <div
                class="process-step-icon d-flex justify-content-center align-items-center mx-auto rounded-circle h-100px w-100px fs-28 bg-prop-theme text-white alt-font">
                <span
                  class="number position-relative z-index-1 alt-font fw-600">01</span>
                <div class="box-overlay bg-slate-blue rounded-circle"></div>
              </div>
              <span class="progress-right-icon d-none d-sm-inline-block">
                <i
                  class="feather icon-feather-chevron-right icon-very-medium text-base-color d-flex"></i>
              </span>
            </div>
            <span class="d-inline-block fw-600 text-dark-gray fs-18">Tailored Property Guidance
            </span>
            <p class="w-75 lg-w-100 sm-w-90 d-inline-block">
              Find homes that match your lifestyle, needs, and future plans.
            </p>
          </div>
          ...
          <div
            ...
            <div class="process-step-icon-box position-relative mb-25px">
              <div
                class="process-step-icon d-flex justify-content-center align-items-center mx-auto rounded-circle h-100px w-100px fs-28 bg-prop-theme text-white alt-font">
                <span
                  class="number position-relative z-index-1 alt-font fw-600">02</span>
                <div class="box-overlay bg-slate-blue rounded-circle"></div>
              </div>
            ...
            <span class="d-inline-block fw-600 text-dark-gray fs-18">Virtual Tools & AI-Powered Matching
            </span>
            <p class="w-75 lg-w-100 sm-w-90 d-inline-block">
              Explore properties with virtual tours, AI-matching, and instant
              support.
            </p>
          </div>
          <!-- end process step item -->
          ...
          <div
            ...
            <div class="process-step-icon-box position-relative mb-25px">
              <div
                class="process-step-icon d-flex justify-content-center align-items-center mx-auto rounded-circle h-100px w-100px fs-28 bg-prop-theme text-white alt-font">
                <span
                  class="number position-relative z-index-1 alt-font fw-600">03</span>
                <div class="box-overlay bg-slate-blue rounded-circle"></div>
              </div>
              <span class="progress-right-icon d-none d-sm-inline-block">
                <i
            ...
            <span class="d-inline-block fw-600 text-dark-gray fs-18">Green Homes for Smart Living
            </span>
            <p class="w-75 lg-w-100 sm-w-90 d-inline-block">
              Choose eco-friendly projects with energy savings and sustainable
              features.
            </p>
          </div>
          <!-- end process step item -->
          ...
          <div
            ...
            <div class="process-step-icon-box position-relative mb-25px">
              <div
                class="process-step-icon d-flex justify-content-center align-items-center mx-auto rounded-circle h-100px w-100px fs-28 bg-prop-theme text-white alt-font">
                <span
                  class="number position-relative z-index-1 alt-font fw-600">04</span>
                <div class="box-overlay bg-slate-blue rounded-circle"></div>
              </div>
              <span class="progress-right-icon d-none d-sm-inline-block">
                <i
            ...
            <span class="d-inline-block fw-600 text-dark-gray fs-18">Strategic Location & Infrastructure Guidance
            </span>
            <p class="w-75 lg-w-100 sm-w-90 d-inline-block">
              Invest in areas with lifestyle amenities and strong growth
              potential.
            </p>
          </div>
          <!-- end process step item -->
          ...
          <div
            ...
            <div class="process-step-icon-box position-relative mb-25px">
              <div
                class="process-step-icon d-flex justify-content-center align-items-center mx-auto rounded-circle h-100px w-100px fs-28 bg-prop-theme text-white alt-font">
                <span
                  class="number position-relative z-index-1 alt-font fw-600">05</span>
                <div class="box-overlay bg-slate-blue rounded-circle"></div>
              </div>
            </div>
            <span class="d-inline-block fw-600 text-dark-gray fs-18">Financing Insights & Buyer Protection
            </span>
            <p class="w-75 lg-w-100 sm-w-90 d-inline-block">
              Get expert loan guidance, incentives, and secure RERA-approved
              options.
            </p>
          </div>
          <!-- end process step item -->
        ...
        <!-- <div class="row">
          <div class="col-12 text-center">
            <div
              class="bg-white border border-color-extra-medium-gray box-shadow-extra-large fw-700 text-dark-gray text-uppercase border-radius-30px ps-20px pe-20px fs-12 me-10px sm-m-5px d-inline-block align-middle">
              Hurray
            </div>
            <div class="text-dark-gray fs-18 d-block d-sm-inline-block">
              Let's make something great work together.
              <a
                href="#"
                class="text-dark-gray text-dark-gray-hover ls-minus-05px text-decoration-line-bottom fw-600"
    ...
    <div class="container">
      <div class="row mb-5 md-mb-50px sm-mb-40px">
        <div class="col-lg-5 md-mb-35px text-center text-lg-start">
          <h3
            class="fw-600 mb-0 text-dark-gray ls-minus-2px sm-ls-minus-1px"
            data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "delay": 0, "staggervalue": 250, "easing": "easeOutQuad" }'>
            Guiding you effortlessly to your dream home.
          </h3>
        </div>
        <div class="col-xl-6 col-lg-7 offset-xl-1 text-center text-lg-start">
          <div class="row align-items-center">
            <!-- start counter item -->
            <div
              class="col-sm-6 last-paragraph-no-margin counter-style-04 xs-mb-35px">
              <h2
                class="vertical-counter d-inline-flex text-dark-gray fw-700 ls-minus-3px xs-ls-minus-1px mb-5px"
                data-text="%"
                data-to="96">
                <sup class="text-jade top-minus-5px"><i class="bi bi-arrow-up icon-medium"></i></sup>
              </h2>
              <span
                class="fs-19 fw-600 ls-minus-05px mb-5px d-block text-dark-gray"
                data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "delay": 0, "staggervalue": 250, "easing": "easeOutQuad" }'>Prefer expert home guidance</span>
              <p
                class="w-90 sm-w-100 md-mx-auto"
                data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "delay": 100, "staggervalue": 250, "easing": "easeOutQuad" }'>
                Most buyers trust professional advice for a smooth purchase.
              </p>
            </div>
            <!-- end counter item -->
            <!-- start counter item -->
            <div class="col-sm-6 last-paragraph-no-margin counter-style-04">
              ...
              <span
                class="fs-19 fw-600 ls-minus-05px mb-5px d-block text-dark-gray"
                data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "delay": 0, "staggervalue": 250, "easing": "easeOutQuad" }'>Choose hassle-free home deals</span>
              <p
                class="w-90 sm-w-100 md-mx-auto"
                data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "delay": 100, "staggervalue": 250, "easing": "easeOutQuad" }'>
                Majority of buyers prefer stress-free transactions.
              </p>
            </div>
            <!-- end counter item -->
          </div>
      ...
      <div class="row justify-content-center mb-5">
        <div
          class="col-12 sliding-box sliding-box-style-02 d-flex lg-flex-nowrap flex-wrap p-md-0"
          ...
          <div class="sliding-box-item md-mb-30px">
            <div class="sliding-box-img overflow-hidden">
              <img src="img/buyers/services_1.jpg" alt="" class="w-100" />
            </div>
            <div
              ...
              <div class="content-hover w-100 last-paragraph-no-margin">
                <i
                  class="line-icon-Medal-2 align-middle icon-extra-large text-base-color mb-45px lg-mb-25px"></i>
                <div class="fw-600 text-dark-gray ls-minus-05px fs-19 mb-5px">
                  Choosing Right Property
                </div>
                <p class="lh-30">
                  Find homes perfectly matching your lifestyle needs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="sliding-box-item active md-mb-30px">
            <div class="sliding-box-img overflow-hidden">
              <img src="img/buyers/services_2.jpg" alt="" class="w-100" />
            </div>
            <div
              class="d-flex flex-column align-items-start justify-content-center sliding-box-content bg-very-light-gray p-50px sm-p-25px">
              <div class="content-hover w-100 last-paragraph-no-margin">
                <i
                  class="line-icon-Money-Bag align-middle icon-extra-large text-base-color mb-45px lg-mb-25px"></i>
                <div class="fw-600 text-dark-gray ls-minus-05px fs-19 mb-5px">
                  Financial Planning
                </div>
                <p class="lh-30">
                  Smart budgeting for stress-free property investment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="sliding-box-item">
            ...
            <div
              ...
              <div class="content-hover w-100 last-paragraph-no-margin">
                <i
                  class="line-icon-Financial align-middle icon-extra-large text-base-color mb-45px lg-mb-25px"></i>
                <div class="fw-600 text-dark-gray ls-minus-05px fs-19 mb-5px">
                  Hassle Free Documentation
                </div>
                <p class="lh-30">
                  Smooth paperwork handled with complete transparency.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="sliding-box-item md-mb-30px">
            ...
            <div
              ...
              <div class="content-hover w-100 last-paragraph-no-margin">
                ...
                <p class="lh-30">Best loan options with quick approvals.</p>
              </div>
            </div>
          </div>
          <!-- end sliding box item -->
          ...
          <div class="sliding-box-item active md-mb-30px">
            ...
            <div
              ...
              <div class="content-hover w-100 last-paragraph-no-margin">
                ...
                <p class="lh-30">
                  Guided tours to explore projects confidently..
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="sliding-box-item">
            ...
            <div
              ...
              <div class="content-hover w-100 last-paragraph-no-margin">
                ...
                <p class="lh-30">
                  Dedicated help even after purchase completion.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div
          ...
          <div
            class="d-inline-block align-middle bg-base-color fw-600 text-white text-uppercase border-radius-30px ps-20px pe-20px fs-12 me-10px lh-30 sm-m-5px">
            Promise
          </div>
          <div
            class="d-inline-block align-middle text-dark-gray fs-19 fw-600 ls-minus-05px">
            Any home buying related question?
            <a
              href="#"
              class="text-decoration-line-bottom text-dark-gray text-base-hover">We're ready to help!</a>
          </div>
        </div>
      </div>
    </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          PropAdvisor Consultancy Services are a Super team
                          with extremely helpful outlook. Honest views and
                          guaranteed full information. Solves every issue or
                          challenge and helps in our decision making.
                        </p>
                      </div>
                      <div
                        ...
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Harish Mehta</span>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Highly recommended. They have many projects in
                          various locations - Kharghar, Airoli, Ulwe,
                          Kalamboli, Panvel, Pushpak Nagar. Safe people to
                          invest in your Home buying.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Matthew Dsouza</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Best Consultancy I have ever experienced, Best
                          guideline Provided for the Property requirement,
                          They are expert in all the project across Mumbai and
                          Navi Mumbai.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Shagun Sharma</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Highly professional and very clear about property
                          advise, Understand the requirement of Customer and
                          hence Provide best in class option with in the
                          budget.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Lisa Mishra</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          PropAdvisor Provide best option with in the budget,
                          Very transparent in deal and handle entire account
                          starting from Searching Property, Home Loan till
                          Possession.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Ankit Sahu</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Propadvisor Consultancy services' having Very
                          professional organisation.Good team and good
                          management. hassle free property purchase.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Priya Gosami</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          All commitments and cashback offer was fulfilled.
                          Overall highly satisfied. I recommend others too to
                          try their service. Positive Responsiveness,
                      ...
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Raj Sharma</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Propadvisor consultancy services is the best real
                          estate company I have ever deal with. very helpful
                          and professional staff.Thank you for your flawless
                          Home buying journey and such a great quality
                          property.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Namita Goel</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
