...
<body
  ...
  <section
    id="home"
    class="p-0 cover-background full-screen bg-dark-gray md-h-600px sm-h-auto top-space-margin"
      ...
      <div class="row justify-content-center align-items-center h-100">
        ...
        <div
          ...
          <h1
            ...
            <div
              class="highlight-separator"
              data-shadow-animation="true"
              data-animation-delay="500">
              fast<span><img
                  src="img/developers/gold_highlight_separator_2.svg"
                  alt="" /></span>
            </div>
          </h1>
          ...
          <a href="contact.html">
            <button
              ...
              <span>
                <span
                  class="btn-double-text fw-400"
                  data-text="Schedule A Consultation">Schedule A Consultation
                </span>
              </span>
            </button>
          </a>
          <div class="feature-box feature-box-left-icon-middle mt-2">
            <div
            ...
            <div
              class="feature-box-content last-paragraph-no-margin text-mountain-gray fs-17 lh-26">
              Reach over
              <span class="text-base-color text-decoration-line-bottom">60,000+</span>
              property buyers.
            </div>
          </div>
        </div>
    ...
    <div
      ...
      fastest selling property
    </div>
  </section>
  <!-- end banner -->
  <template>
    <!-- start section -->
    <section class="overflow-hidden bg-gradient-very-light-gray xs-pb-30px">
      <div class="container-fluid">
        <!-- <div class="row justify-content-center mb-1">
          <div
            class="col-xxl-4 col-xl-5 col-lg-7 col-sm-9 text-center"
            data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
            <span
              class="fs-15 text-uppercase text-base-color fw-600 mb-10px d-block ls-1px"
              >What We Offer
            </span>
            <h3 class="fw-700 text-dark-gray ls-minus-1px">
        ...
        <div class="row justify-content-center mb-1">
          <div
            ...
            <div class="mb-10px">
              ...
              <span
                class="text-gradient-base-color fs-15 alt-font fw-700 ls-05px text-uppercase d-inline-block align-middle">What We Offer</span>
            </div>
        ...
        <div class="row">
          <div class="col-12 position-relative p-0">
            <div
              class="outside-box-right-15 sm-outside-box-right-0 outside-box-left-15 sm-outside-box-left-0">
              <div
                class="swiper magic-cursor"
                data-slider-options='{ "slidesPerView": 1, "spaceBetween": 30, "loop": true, "pagination": { "el": ".slider-four-slide-pagination-1", "clickable": true, "dynamicBullets": false }, "autoplay": { "delay": 2000, "disableOnInteraction": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "1200": { "slidesPerView": 5 }, "992": { "slidesPerView": 4 }, "768": { "slidesPerView": 3 }, "320": { "slidesPerView": 1 } }, "effect": "slide" }'
                data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                <div class="swiper-wrapper pt-20px pb-20px">
                  <!-- start slider item -->
                  <div class="swiper-slide sm-p-15px">
                    <div
                      class="box-shadow-extra-large services-box-style-01 hover-box border-radius-8px overflow-hidden last-paragraph-no-margin">
                      <div class="position-relative box-image">
                        <img
                          src="img/developers/services/Exclusive-Mandates-And-Sole-Selling.jpg"
                          alt="" />
                        <div class="box-overlay bg-dark-gray"></div>
                        <a
                          href=""
                          class="d-flex justify-content-center align-items-center mx-auto icon-box absolute-middle-center z-index-1 w-110px h-110px rounded-circle bg-base-color text-white text-uppercase fw-600 p-15px text-center lh-20 fs-15 box-shadow-extra-large">Start now</a>
                      </div>
                      <div class="p-11 bg-white text-center">
                        <a
                          href=""
                          class="d-inline-block fs-18 fw-600 ls-minus-05px text-dark-gray mb-5px">Exclusive Mandates & Sole Selling
                        </a>
                        <p>
                          Dedicated mandate services with targeted campaigns
                  ...
                  <div class="swiper-slide sm-p-15px">
                    <div
                      ...
                      <div class="position-relative box-image">
                        <img
                          src="img/developers/services/Sales-And-Project-Execution.jpg"
                          alt="" />
                        <div class="box-overlay bg-dark-gray"></div>
                        <a
                          href=""
                      ...
                      <div class="p-11 bg-white text-center">
                        <a
                          href=""
                          class="d-inline-block fs-18 fw-600 ls-minus-05px text-dark-gray mb-5px">Sales & Project Execution
                        </a>
                        <p>
                          From launch planning to buyer closure, we manage
                          sales end-to-end.
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="swiper-slide sm-p-15px">
                    <div
                      ...
                      <div class="position-relative box-image">
                        <img
                          src="img/developers/services/Marketing-Strategy-And-Buyer-Insights.jpg"
                          alt="" />
                        <div class="box-overlay bg-dark-gray"></div>
                        <a
                          href=""
                      ...
                      <div class="p-11 bg-white text-center">
                        <a
                          href=""
                          class="d-inline-block fs-18 fw-600 ls-minus-05px text-dark-gray mb-5px">Market Strategy & Buyer Insights
                        </a>
                        <p>
                  ...
                  <div class="swiper-slide sm-p-15px">
                    <div
                      ...
                      <div class="position-relative box-image">
                        <img
                          src="img/developers/services/Sustainability-And-Future-Ready-Development.jpg"
                          alt="" />
                        <div class="box-overlay bg-dark-gray"></div>
                        <a
                          href=""
                      ...
                      <div class="p-11 bg-white text-center">
                        <a
                          href=""
                          class="d-inline-block fs-18 fw-600 ls-minus-05px text-dark-gray mb-5px">Sustainability & Future-Ready Development
                        </a>
                        <p>
                          Guidance on eco-friendly design, smart homes, and
                  ...
                  <div class="swiper-slide sm-p-15px">
                    <div
                      ...
                      <div class="position-relative box-image">
                        <img
                          src="img/developers/services/Redevelopment-And-Consortium-Guidance.jpg"
                          alt="" />
                        <div class="box-overlay bg-dark-gray"></div>
                        <a
                          href=""
                      ...
                      <div class="p-11 bg-white text-center">
                        <a
                          href=""
                          class="d-inline-block fs-18 fw-600 ls-minus-05px text-dark-gray mb-5px">Redevelopment & Consortium Guidance
                        </a>
                        <p>
                          Support for approvals, joint ventures, and
                  ...
                  <div class="swiper-slide sm-p-15px">
                    <div
                      ...
                      <div class="position-relative box-image">
                        <img
                          src="img/developers/services/Digital-Enablement-And-Visibility.jpg"
                          alt="" />
                        <div class="box-overlay bg-dark-gray"></div>
                        <a
                          href=""
                      ...
                      <div class="p-11 bg-white text-center">
                        <a
                          href=""
                          class="d-inline-block fs-18 fw-600 ls-minus-05px text-dark-gray mb-5px">Digital Enablement & Visibility
                        </a>
                        <p>
                          Boost reach with virtual tours, AI tools, and
                          digital campaigns.
                        </p>
                      </div>
                    </div>
          ...
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              ...
              <div class="rotate-content-front z-index-2 p-30px">
                ...
                <span>Dedicated mandate services with targeted ...</span>
              </div>
            </div>
            <!-- end front side -->
            <!-- start back side -->
            <div
              ...
              style="
                  background-image: url('img/developers/services/Exclusive-Mandates-And-Sole-Selling.jpg');
                ">
              ...
              <div
                ...
                <span class="text-white alt-font fw-500 fs-19 mb-5px">Exclusive Mandates
                </span>
                <p>
                  Dedicated mandate services with targeted campaigns and
                  seamless project execution
                </p>
                <a
                  href="#"
                  class="btn btn-small btn-rounded btn-white btn-box-shadow">Learn more</a>
              </div>
              <!-- end back side -->
            </div>
          </div>
          ...
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              ...
              <div class="rotate-content-front z-index-2 p-30px">
                <img
                  class="mb-25px h-70px"
                  src="img/developers/services/service_icon/demo-lawyer-practice-areas-icon-02.svg"
                  alt="" />
                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">
                  Sole Selling
                </div>
                <span>From launch planning to buyer closure...</span>
              </div>
            </div>
            <!-- end front side -->
            <!-- start back side -->
            <div
              class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large"
              style="
                  background-image: url('img/developers/services/Digital-Enablement-And-Visibility.jpg');
                ">
              <div class="opacity-light bg-charcoal-blue"></div>
              <div
                class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                <span class="text-white alt-font fw-500 fs-19 mb-5px">
                  Sole Selling
                </span>
                <p>
                  From launch planning to buyer closure, we manage sales
                  end-to-end.
                </p>
                <a
                  href="#"
        ...
        <div class="col rotate-box-style-02 mb-30px">
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large"
              style="
                  background-image: url('img/developers/services/Marketing-Strategy-And-Buyer-Insights.jpg');
                ">
              <div class="opacity-light bg-charcoal-blue"></div>
              <div
                class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
          ...
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              ...
              <div class="rotate-content-front z-index-2 p-30px">
                <img
                  class="mb-25px h-70px"
                  src="img/developers/services/service_icon/demo-lawyer-practice-areas-icon-03.svg"
                  alt="" />
                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">
                  Market Strategy & Buyer Insights
                </div>
                <span>Actionable insights on trends, demand...</span>
              </div>
            </div>
            <!-- end front side -->
            <!-- start back side -->
            <div
              class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large"
              style="
                  background-image: url('img/developers/services/Sales-And-Project-Execution.jpg');
                ">
              <div class="opacity-light bg-charcoal-blue"></div>
              <div
                class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                ...
                <p>
                  Actionable insights on trends, demand, and buyer behavior in
                  Navi Mumbai.
                </p>
                <a
                  href="#"
          ...
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              ...
              <div class="rotate-content-front z-index-2 p-30px">
                <img
                  class="mb-25px h-70px"
                  src="img/developers/services/service_icon/demo-lawyer-practice-areas-icon-04.svg"
                  alt="" />
                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">
          ...
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              ...
              <div class="rotate-content-front z-index-2 p-30px">
                <img
                  class="mb-25px h-70px"
                  src="img/developers/services/service_icon/demo-lawyer-practice-areas-icon-05.svg"
                  alt="" />
                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">
                  End to End Sales
                </div>
            ...
            <div
              class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large"
              style="
                  background-image: url('img/developers/services/Redevelopment-And-Consortium-Guidance.jpg');
                ">
              <div class="opacity-light bg-charcoal-blue"></div>
              <div
                class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                <span class="text-white alt-font fw-500 fs-19 mb-5px">End to End Sales</span>
                <p>Quis autem velo eum iure suam nihil molestiae.</p>
                <a
                  href="#"
                  class="btn btn-small btn-rounded btn-white btn-box-shadow">Learn more</a>
          ...
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              ...
              <div class="rotate-content-front z-index-2 p-30px">
                <img
                  class="mb-25px h-70px"
                  src="img/developers/services/service_icon/demo-lawyer-practice-areas-icon-06.svg"
                  alt="" />
                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">
                  Securities law
                </div>
            ...
            <div
              ...
              <div
                class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
                <span class="text-white alt-font fw-500 fs-19 mb-5px">Securities Checks</span>
                <p>Quis autem velo eum iure suam nihil molestiae.</p>
                <a
                  href="#"
                  class="btn btn-small btn-rounded btn-white btn-box-shadow">Learn more</a>
          ...
          <div class="w-100 min-h-300px text-center rotate-box to-left">
            ...
            <div
              ...
              <div class="rotate-content-front z-index-2 p-30px">
                <img
                  class="mb-25px h-70px"
                  src="img/developers/services/service_icon/demo-lawyer-practice-areas-icon-07.svg"
                  alt="" />
                <div class="fs-19 text-dark-gray alt-font fw-600 mb-5px">
            ...
            <div
              class="w-100 h-100 overflow-hidden back-side cover-background border-radius-6px box-shadow-quadruple-large"
              style="
                  background-image: url('img/developers/services/Sustainability-And-Future-Ready-Development.jpg');
                ">
              <div class="opacity-light bg-charcoal-blue"></div>
              <div
                class="d-flex flex-column align-items-center justify-content-center h-100 z-index-2 rotate-content-back p-30px">
  ...
  <section
    ...
    style="
        background-image: url('img/common/vertical-line-bg-medium-gray.svg');
      ">
    <div class="container overlap-gap-section position-relative">
      <!-- <div
        ...
        <div
          class="position-absolute bottom-40px md-bottom-60px left-minus-50px">
          <img
            src="https://placehold.co/150x86"
      ...
      <div class="row justify-content-center mb-1">
        <div
          class="col-xxl-6 col-xl-6 col-lg-7 col-sm-9 text-center"
          data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
          <div class="mb-10px">
            <!-- <span
                class="w-25px h-1px d-inline-block bg-base-color me-5px align-middle"></span> -->
      ...
      <div
        ...
        <div
          class="col icon-with-text-style-10 md-mb-50px mt-30px"
          ...
          <div
            ...
            <div
              ...
              <i
                class="fa-solid fa-globe icon-extra-large text-dark-gray"></i>
            </div>
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-handshake icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-award icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-chart-line icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-microchip icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-coins icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-user-tie icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-clipboard-check icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
              <span class="d-inline-block fw-500 text-dark-gray mb-5px fs-18">
        ...
        <div
          ...
          <div
            ...
            <div
              class="feature-box-icon feature-box-icon-rounded w-100px h-100px rounded-circle mb-20px">
              <i
                class="fa-solid fa-arrow-trend-up icon-extra-large text-dark-gray"></i>
            </div>
            <div class="feature-box-content last-paragraph-no-margin">
              <span class="d-inline-block fw-500 text-dark-gray mb-5px fs-18">
                High ROI
      ...
      <!-- <div
          ...
          <div class="col-auto text-center last-paragraph-no-margin">
            <div class="d-inline-block align-middle me-15px sm-m-5px">
              <img src="images/demo-ebook-01.jpg" alt="" />
            </div>
            <div
              class="d-inline-block text-dark-gray fs-24 align-middle ls-minus-05px">
              I read a book one day and
              <span class="fw-500 text-decoration-line-bottom"
                >my whole life was changed.</span
              >
            </div>
          </div>
        </div> -->
  ...
  <template>
    ...
    <section>
      <div class="container">
        <!-- <h2 class="fw-500 ls-minus-2px alt-font text-dark-gray text-uppercase">
          Our Case Studies
        </h2> -->
        ...
        <div class="row">
          <div class="col-12 position-relative">
            <div
              class="vertical-title-center align-items-center position-absolute top-0px left-15px bg-prop-theme p-10px xs-p-5px h-270px sm-h-190px z-index-9 w-50px xs-w-40px">
              <div
                class="title fs-14 ls-2px text-black fw-700 text-uppercase">
                Recent projects
              </div>
            </div>
            <div
              class="swiper position-relative text-slider-style-04"
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <!-- <img src="images/latest-imgs/Delta Prestige.jpg" alt="" /> -->
                  <img
                    src="img/case_study/Project_Delta_Prestige.jpg"
                    alt="" />
                  <div
                    class="container position-absolute sm-position-relative bottom-0 right-0px z-index-1 swiper-slide-content">
                    <div
                      class="row justify-content-end align-items-end h-100">
                      <div class="col-lg-6 col-md-8 p-0">
                        <div class="bg-white p-16 lg-p-12">
                          <span
                            class="text-dark-gray opacity-5 fs-15 text-uppercase ls-1px fw-500">Kharghar</span>
                          <h3
                            class="text-dark-gray fw-600 mb-20px ls-minus-2px">
                            Premium 3BHK Towers in Kharghar
                          </h3>
                          <p class="w-90 mb-20px">
                            The Kharghar micro-market is a hotspot for premium
                            and luxury projects, with multiple developers
                ...
                <!-- start text slider item -->
                <div class="swiper-slide">
                  <img src="img/case_study/Project_Invicta_Ulve.jpg" alt="" />
                  <div
                    class="container position-absolute sm-position-relative bottom-0 right-0px z-index-1 swiper-slide-content">
                    <div
                      class="row justify-content-end align-items-end h-100">
                      <div class="col-lg-6 col-md-8 p-0">
                        <div class="bg-white p-16 lg-p-12">
                          <span
                            class="text-dark-gray opacity-5 fs-15 text-uppercase ls-1px fw-500">Ulwe</span>
                          <h3
                            class="text-dark-gray fw-600 mb-20px ls-minus-2px">
                            Mid-Income Housing Project in Ulwe
                          </h3>
                          <p class="w-90 mb-20px">
                            A mid-income housing project in Ulwe, Navi Mumbai,
                            was struggling to generate traction during its
                            pre-launch phase.
                          </p>
                          <a
                ...
                <div class="swiper-slide">
                  <img
                    src="img/case_study/Project_Invicta_Ecalt.jpg"
                    alt="" />
                  <div
                    class="container position-absolute sm-position-relative bottom-0 right-0px z-index-1 swiper-slide-content">
                    <div
                      ...
                      <div class="col-lg-6 col-md-8 p-0">
                        <div class="bg-white p-16 lg-p-12">
                          <span
                            class="text-dark-gray opacity-5 fs-15 text-uppercase ls-1px fw-500">Pushpak Nagar</span>
                          <h3
                            class="text-dark-gray fw-600 mb-20px ls-minus-2px">
                            Pushpak Nagar Project
                          </h3>
                          <p class="w-90 mb-20px">
                            A residential project in Pushpak Nagar, Navi
                            Mumbai, faced tough competition and limited buyer
                            awareness despite being located near the upcoming
        ...
        <p class="mt-50px">
          PropAdvisor ensures every project reaches the right buyers. By
          blending data-driven insights, lifestyle-driven branding, and
          targeted buyer outreach, we help developers accelerate sales,
          differentiate in competitive markets, and unlock real value from
          their projects.
        </p>
      </div>
    </section>
  ...
  <!-- start section -->
  <section id="reviews" class="overflow-hidden">
    <div class="container-fluid">
      <!-- <div class="row justify-content-center mb-1">
          <div class="col-lg-7 text-center">
            <span class="d-block text-uppercase mb-5px text-base-color fw-500"
              >Why you should buy this?</span
            >
            <h2 class="fw-500 alt-font text-dark-gray ls-minus-2px">
              Developers Reviews
            </h2>
          </div>
        </div> -->
                  ...
                  <div class="review-style-05">
                    <div
                      ...
                      <div
                        ...
                        <!-- <img
                            class="rounded-circle w-110px md-w-75px h-110px md-h-75px me-30px"
                            src="https://placehold.co/200x200"
                            alt="" /> -->
                        <img
                          class="rounded-circle w-110px md-w-75px h-110px md-h-75px me-30px"
                          src="img/common/dummy_profile.jpg"
                          alt="" />
                        <p>
                          PropAdvisor understood our Kharghar micro-market
                          cold. Within the first quarter, our site visits
                          doubled and cancellations dropped.
                        </p>
                      </div>
                      <div
                        ...
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Skyline Spaces (Kharghar)
                        </span>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          We tried multiple channel partners before,but
                          PropAdvisor discipline on follow-ups and weekly
                          dashboards was a game changer.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Airoli Constructions
                        </span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          PropAdvisor positioned our Seawoods premium
                          inventory perfectly—no discounting, no noise. Their
                          digital + on-ground strategy gave us consistent
                      ...
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Navkaar Developers
                        </span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Ulwe buyers are hyper price-sensitive. PropAdvisor
                          built a sharp lead matrix and got us serious site
                          visits in under three weeks. Conversions improved
                          because every prospect came pre-qualified
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Crescent Realty (Ulwe)
                        </span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          The PropAdvisor team realigned our messaging around
                          commute and schools for Vashi end-users. CTRs went
                          up, cost per lead went down, and our sales team
                          finally stopped chasing dead ends.
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Meridian Group (Vashi)
                        </span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Taloja needs ground intelligence. PropAdvisor ran
                          micro-events, broker meets, and digital retargeting
                          in sync. We cleared aging 2-BHK inventory without
                      ...
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Greenstone Projects</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          Our Panvel launch needed velocity. PropAdvisor
                          mapped NRI + Navi Mumbai upgrade segments and built
                          a clean pipeline. The weekly mandate reviews kept
                          everyone accountable—from creatives to closures
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">BluePeak Builders</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <img
                          ...
                          alt="" />
                        <p>
                          PropAdvisor’s buyer profiling nailed who we should
                          talk to and who to drop. Fewer site visits, higher
                          conversions—that’s exactly what a mandate partner
                          should deliver
                        </p>
                      </div>
                      <div
                        class="d-flex align-items-center border-top border-color-extra-medium-gray pt-15px pb-15px ps-45px pe-45px xl-ps-25px xl-pe-25px">
                        <span
                          class="fs-17 fw-500 text-dark-gray me-auto xs-fs-15">Lotus Habitat</span>
                        <div class="review-star-icon fs-19 xs-fs-15">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                        </div>
                      </div>
      ...
      <!-- <div class="row">
          <div class="col-12 text-center">
            <div
              class="d-inline-block bg-dark-gray review-star-icon border-radius-4px ps-15px pe-15px fs-15 lh-36 ls-minus-1px me-15px sm-m-10px align-middle">
            ...
            <h6
              class="text-dark-gray fw-400 mb-0 d-inline-block align-middle ls-minus-1px">
              Check all reviews on
              <a href="https://www.google.com/" target="_blank">
                <img src="img/common/logo_google.svg" width="100px" alt="" />
              </a>
            </h6>
          </div>
        </div> -->
  ...
  <section
    id="contact"
    class="bg-theme-3 background-position-right-top background-no-repeat"
    ...
    <div class="container">
      <div
        ...
        <div class="col-lg-6">
          <div class="ps-15 pe-15 pt-13 pb-13 lg-p-9 md-p-0 h-100 text-white">
            <span
              class="d-block text-uppercase mb-10px text-base-color fw-500">Contact with us</span>
            <h2 class="fw-500 alt-font text-dark text-uppercase ls-minus-2px">
              How to Partner
            </h2>
