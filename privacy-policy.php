...
<body
  ...
  <section
    ...
    style="background-image: url('img/contact/contact_head_banner.jpg')">
    ...
    <div class="container">
      <div
        ...
        <div
          ...
          <h1 class="mb-20px text-white fw-600 ls-minus-1px">Privacy Policy
          </h1>
        </div>
      </div>
    </div>
  ...
  <!-- start section -->
  <section class="pb-0 privacy-policy-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <h4 class="fw-500 text-dark-gray w-90 md-w-100">Privacy Policy</h4>
          <p class="fs-5 text-base-color fw-600">
        ...
        <div class="col-lg-10 mb-3 sm-mb-35px">
          <p>
          ...
          <h5 class="text-base-color">Interpretation and Definitions</h5>
          <strong class="fs-20 text-base-color"> - Interpretation</strong>
          <p>
          ...
          <strong class="fs-20 text-base-color"> - Definitions</strong>
          <p>For the the purposes of this Privacy Policy:</p>
        ...
        <div class="col-lg-10 mb-3 sm-mb-35px">
          ...
          <strong class="fs-20 text-base-color">
            - Types of Data Collected</strong>
          <br />
          <strong class="fs-20 text-base-color"> - Personal Data</strong>
          <p>
          ...
          <!--  -->
          <strong class="fs-20 text-base-color">
            - Tracking Technologies and Cookies</strong>
          <p>
        ...
        <div class="col-lg-10 mb-3 sm-mb-35px">
          ...
          <ul class="list-style-policy">
            ...
            <li>
              <strong>To contact You:</strong>iTo contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.
            </li>
            <li>
