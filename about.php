      ...
      <div
        ...
        <div class="col-md-6 col-sm-8 md-mb-35px">
          <div
            ...
            <div class="col-auto">
              <span
                class="alt-font text-dark-gray fw-600 fs-100 lg-fs-110 ls-minus-7px">10+</span>
            </div>
            ...
            <div
              ...
              <span
                class="fw-400 fs-110 text-base-color position-relative top-minus-10px">|</span>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row justify-content-center mb-3">
        <div
          ...
          data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
          <span
            class="bg-white text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-dark lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Our Guiding Vision
          </span>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div
          ...
          <span
            class="text-gradient-base-color fs-15 alt-font fw-700 ls-05px text-uppercase d-inline-block align-middle">Our Mission</span>
          <h3
            class="fw-600 text-dark-gray ls-minus-2px alt-font sm-w-80 xs-w-100 mx-auto sm-mb-20px">
    ...
    <div class="container position-relative">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-xl-6 text-center text-xl-start lg-mb-30px">
          ...
          <span class="fs-19 widget-text opacity-5 fw-300">Your Seamless Real Estate Journey Starts Here With
            Propadvisor.</span>
        </div>
        <!-- end footer column -->
        <!-- start footer column -->
